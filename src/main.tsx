    ...
    <div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
        ...
        <div className="space-y-6">
          ...
          <EntryDateForecast trips={activeProfile.trips} />
        </div>
...
const App = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50 text-gray-900 font-sans relative">
      ...
      <div 
        className="md:hidden fixed bottom-0 left-0 right-0 bg-white border-t border-gray-200 z-50 flex justify-around px-3 py-2 gap-1 shadow-lg"
      ...
      <main className="flex-1 flex flex-col min-w-0 bg-gray-50/50">
        ...
        <div 
          className="flex-1 overflow-y-auto p-4 md:p-8 lg:p-12 pb-24 md:pb-8"
